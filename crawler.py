...
class Crawler:
    ...
    def crawl(self, urlList, maxDepth=1):
        ...
        for currDepth in range(0, maxDepth):
            ...
            pass
        print('/-----------------------------------/')
        print('8б Первые 20 наиболее часто проиндексированных ссылок:')
        self.dictSort(self.dictionaryURL)
        print('/-----------------------------------/')
        print('8в 20 наиболее часто встречающихся слов на страницах:')
        self.dictSort(self.dictionaryWords)
        print('/-----------------------------------/')
        print('8а Количество строк в таблицах:')
        self.printValues()
        pass
